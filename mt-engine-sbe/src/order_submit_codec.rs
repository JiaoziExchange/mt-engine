...
pub use decoder::OrderSubmitDecoder;
pub use encoder::OrderSubmitEncoder;
...
pub mod encoder {
    ...
    pub struct OrderSubmitEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for OrderSubmitEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for OrderSubmitEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct OrderSubmitDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for OrderSubmitDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for OrderSubmitDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for OrderSubmitDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
