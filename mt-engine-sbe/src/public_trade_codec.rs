...
pub use decoder::PublicTradeDecoder;
pub use encoder::PublicTradeEncoder;
...
pub mod encoder {
    ...
    pub struct PublicTradeEncoder<'a> {
        buf: WriteBuf<'a>,
    ...
    impl<'a> Writer<'a> for PublicTradeEncoder<'a> {
        #[inline]
    ...
    impl<'a> Encoder<'a> for PublicTradeEncoder<'a> {
        #[inline]
...
pub mod decoder {
    ...
    pub struct PublicTradeDecoder<'a> {
        buf: ReadBuf<'a>,
        initial_offset: usize,
        offset: usize,
        limit: usize,
    ...
    impl ActingVersion for PublicTradeDecoder<'_> {
        #[inline]
    ...
    impl<'a> Reader<'a> for PublicTradeDecoder<'a> {
        #[inline]
    ...
    impl<'a> Decoder<'a> for PublicTradeDecoder<'a> {
        #[inline]
        fn get_limit(&self) -> usize {
            self.limit
        }
